...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		<form class="layui-form">
			...
			<div style="margin-top: 1%">
				...
				<shiro:hasPermission name="users:users:save">
					<div class="layui-inline">
	...
	<script type="text/html" id="barEdit">
		<shiro:hasPermission name="users:users:update">
						...
						function() {
							...
							table
									.render({
										id : 'userList',
										elem : '#userList',
										url : ctx + '/users/getUserList' //数据接口
										,
										limit : 10//每页默认数
										,
										limits : [ 10, 20, 30, 40 ],
